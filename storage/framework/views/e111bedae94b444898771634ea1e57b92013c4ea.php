...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 <?php if(!empty($authUser->userGroup)): ?> has-user-group <?php endif; ?> without-bottom-image" <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
...
<?php /**PATH /Volumes/Datagram/__MACOSX/resources/views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>