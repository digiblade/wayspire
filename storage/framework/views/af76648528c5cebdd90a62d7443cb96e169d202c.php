...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span
                            class="font-16 text-dark-blue text-gray font-weight-500"><?php echo e(trans('panel.open_meetings')); ?></span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span
                            class="font-16 text-dark-blue text-gray font-weight-500"><?php echo e(trans('panel.total_meetings')); ?></span>
                    </div>
                </div>
    ...
    <section class="mt-25 bg-light p-2 rounded"">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="from" autocomplete="off"
                                        class="form-control <?php if(!empty(request()->get('from'))): ?> datepicker <?php else: ?> datefilter <?php endif; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="to" autocomplete="off"
                                        class="form-control <?php if(!empty(request()->get('to'))): ?> datepicker <?php else: ?> datefilter <?php endif; ?>"
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="day" name="day">
                                    ...
                                    <option value="saturday" <?php echo e(request()->get('day') === 'saturday' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('public.saturday')); ?></option>
                                    <option value="sunday" <?php echo e(request()->get('day') === 'sunday' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('public.sunday')); ?></option>
                                    <option value="monday" <?php echo e(request()->get('day') === 'monday' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('public.monday')); ?></option>
                                    <option value="tuesday" <?php echo e(request()->get('day') === 'tuesday' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('public.tuesday')); ?></option>
                                    <option value="wednesday"
                                        <?php echo e(request()->get('day') === 'wednesday' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('public.wednesday')); ?></option>
                                    <option value="thursday" <?php echo e(request()->get('day') === 'thursday' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('public.thursday')); ?></option>
                                    <option value="friday" <?php echo e(request()->get('day') === 'friday' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('public.friday')); ?></option>
                                </select>
                            </div>
                        </div>
                                        ...
                                        <select name="instructor_id" class="form-control select2 ">
                                            ...
                                            <?php $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($instructor->id); ?>"
                                                    <?php if(request()->get('instructor_id') == $instructor->id): ?> selected <?php endif; ?>>
                                                    <?php echo e($instructor->full_name); ?></option>
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="open"
                                                <?php echo e(request()->get('status') === 'open' ? 'selected' : ''); ?>>
                                                <?php echo e(trans('public.open')); ?></option>
                                            <option value="finished"
                                                <?php echo e(request()->get('status') === 'finished' ? 'selected' : ''); ?>>
                                                <?php echo e(trans('public.finished')); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="mt-35 bg-light p-2 rounded">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title"><?php echo e(trans('panel.meeting_list')); ?></h2>

            <form action="/panel/meetings/reservation?<?php echo e(http_build_query(request()->all())); ?>"
                ...
                <label class="cursor-pointer mb-0 mr-10 text-gray font-14 font-weight-500"
                    for="openMeetingResult"><?php echo e(trans('panel.show_only_open_meetings')); ?></label>
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="open_meetings" class="js-panel-list-switch-filter custom-control-input"
                        id="openMeetingResult" <?php echo e(request()->get('open_meetings', '') == 'on' ? 'checked' : ''); ?>>
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $reserveMeetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ReserveMeeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-left">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    <div class="avatar bg-gray200">
                                                        <img src="<?php echo e($ReserveMeeting->meeting->creator->getAvatar()); ?>"
                                                            class="img-cover" alt="">
                                                    </div>
                                                    <div class=" ml-5">
                                                        <span
                                                            class="d-block font-weight-500"><?php echo e($ReserveMeeting->meeting->creator->full_name); ?></span>
                                                        <span
                                                            class="mt-5 font-12 text-gray d-block"><?php echo e($ReserveMeeting->meeting->creator->email); ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <span
                                                    class="font-weight-500"><?php echo e(trans('update.' . $ReserveMeeting->meeting_type)); ?></span>
                                            </td>
                                            <td class="align-middle">
                                                <span
                                                    class="font-weight-500"><?php echo e(dateTimeFormat($ReserveMeeting->start_at, 'D')); ?></span>
                                            </td>
                                            <td class="align-middle">
                                            ...
                                            <td class="align-middle">
                                                <div
                                                    class="d-inline-flex align-items-center rounded bg-gray200 py-5 px-15 font-14 font-weight-500">
                                                    <span
                                                        class=""><?php echo e(dateTimeFormat($ReserveMeeting->start_at, 'H:i')); ?></span>
                                                    <span class="mx-1">-</span>
                                                    <span
                                                        class=""><?php echo e(dateTimeFormat($ReserveMeeting->end_at, 'H:i')); ?></span>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <?php switch($ReserveMeeting->status):
                                                    case (\App\Models\ReserveMeeting::$pending): ?>
                                                        <span
                                                            class="text-warning font-weight-500"><?php echo e(trans('public.pending')); ?></span>
                                                    <?php break; ?>
                                                    ...
                                                    <?php case (\App\Models\ReserveMeeting::$finished): ?>
                                                        <span
                                                            class="font-weight-500 text-primary"><?php echo e(trans('public.finished')); ?></span>
                                                    <?php break; ?>

                                                    <?php case (\App\Models\ReserveMeeting::$canceled): ?>
                                                        <span
                                                            class="text-danger font-weight-500"><?php echo e(trans('public.canceled')); ?></span>
                                                    <?php break; ?>
                                                <?php endswitch; ?>
                                            </td>
                                            ...
                                            <td class="align-middle text-right">
                                                <?php if(!in_array($ReserveMeeting->status, [\App\Models\ReserveMeeting::$finished, \App\Models\ReserveMeeting::$canceled])): ?>
                                                    <input type="hidden"
                                                        class="js-meeting-password-<?php echo e($ReserveMeeting->id); ?>"
                                                        value="<?php echo e($ReserveMeeting->password); ?>">
                                                    <input type="hidden"
                                                        class="js-meeting-link-<?php echo e($ReserveMeeting->id); ?>"
                                                        value="<?php echo e($ReserveMeeting->link); ?>">
                                                    ...
                                                    <div class="btn-group dropdown table-actions">
                                                        ...
                                                        <div class="dropdown-menu menu-lg">
                                                            ...
                                                            <?php if(getFeaturesSettings('agora_for_meeting') and
                                                                ...
                                                                <?php if(!empty($ReserveMeeting->session)): ?>
                                                                    <button type="button"
                                                                        ...
                                                                        data-date="<?php echo e(dateTimeFormat($ReserveMeeting->start_at, 'j M Y H:i')); ?>"
                                                                        data-link="<?php echo e($ReserveMeeting->session->getJoinLink()); ?>"
                                                            ...
                                                            <button type="button" data-id="<?php echo e($ReserveMeeting->id); ?>"
                                                                class="webinar-actions js-finish-meeting-reserve d-block btn-transparent mt-10 font-weight-normal"><?php echo e(trans('panel.finish_meeting')); ?></button>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </td>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/panel/meeting/reservation.blade.php ENDPATH**/ ?>