...
<?php $__env->startSection('content'); ?>
    ...
    <section
        class="container course-content-section <?php echo e($course->type); ?> <?php echo e(($hasBought or $percent) ? 'has-progress-bar' : ''); ?>">
        <div class="row">
                ...
                <div class="course-content-body user-select-none">
                    <div class="course-body-on-cover text-white">
                        ...
                        <div class="mt-15">
                            ...
                            <a href="<?php echo e($course->teacher->getProfileUrl()); ?>" target="_blank"
                                class="text-decoration-underline text-white font-14 font-weight-500"><?php echo e($course->teacher->full_name); ?></a>
                        </div>
                            ...
                            <div class="mt-30 d-flex align-items-center ">
                                ...
                                <span class="ml-15 font-14 font-weight-500">
                                    ...
                                    <?php elseif(!is_null($course->capacity)): ?>
                                        <?php echo e($course->getSalesCount()); ?>/<?php echo e($course->capacity); ?>
                    ...
                    <?php if(
                        ...
                        <?php $__currentLoopData = $instructorDiscounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructorDiscount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('web.default.includes.discounts.instructor_discounts_card', [
                                ...
                                'instructorDiscountClassName' => 'mt-35',
                    ...
                    <div class="mt-35 ">
                        ...
                        <div class="tab-content bg-light p-2 rounded mt-2" id="nav-tabContent">
            ...
            <div class="course-content-sidebar col-12 col-lg-4 mt-25 mt-lg-0 bg-light p-2 rounded">
                <div class="rounded-lg shadow-sm">
                    ...
                    <div class="px-20 pb-30 ">
                                    ...
                                    <?php if(!empty($activeSpecialOffer)): ?>
                                        <div class="text-center">
                                            ...
                                            <?php if(!empty($priceWithDiscount['tax'])): ?>
                                                <span class="d-block font-14 text-gray">+ <?php echo e($priceWithDiscount['tax']); ?>
                            ...
                            <div class="mt-20 d-flex flex-column">
                                <?php if(!$canSale and $course->canJoinToWaitlist()): ?>
                                    <button type="button" data-slug="<?php echo e($course->slug); ?>"
                                        class="btn btn-primary <?php echo e(!$authUserJoinedWaitlist ? (!empty($authUser) ? 'js-join-waitlist-user' : 'js-join-waitlist-guest') : 'disabled'); ?>"
                                        <?php echo e($authUserJoinedWaitlist ? 'disabled' : ''); ?>>
                                ...
                                <?php elseif(!empty($course->price) and $course->price > 0): ?>
                                    <button type="button"
                                        class="btn btn-primary <?php echo e($canSale ? 'js-course-add-to-cart-btn' : $course->cantSaleStatus($hasBought) . ' disabled '); ?>">
                                        <?php if(!$canSale): ?>
                                    ...
                                    <?php if($canSale and !empty($course->points)): ?>
                                        <a href="<?php echo e(!auth()->check() ? '/login' : '#'); ?>"
                                            class="<?php echo e(auth()->check() ? 'js-buy-with-point' : ''); ?> btn btn-outline-warning mt-20 <?php echo e(!$canSale ? 'disabled' : ''); ?>"
                                            rel="nofollow">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($canSale ? '/course/' . $course->slug . '/free' : '#'); ?>"
                                        class="btn btn-primary <?php echo e(!$canSale ? ' disabled ' . $course->cantSaleStatus($hasBought) : ''); ?>">
                                        <?php if(!$canSale): ?>
                                            <?php if($course->checkCapacityReached()): ?>
                                                <?php echo e(trans('update.capacity_reached')); ?>
                                ...
                                <?php if($canSale and $course->subscribe): ?>
                                    <a href="/subscribes/apply/<?php echo e($course->slug); ?>"
                                        class="btn btn-outline-primary btn-subscribe mt-20 <?php if(!$canSale): ?> disabled <?php endif; ?>"><?php echo e(trans('public.subscribe')); ?></a>
                                <?php endif; ?>
                        ...
                        <div class="mt-35">
                            <strong
                                class="d-block text-secondary font-weight-bold"><?php echo e(trans('webinars.this_webinar_includes', ['classes' => trans('webinars.' . $course->type)])); ?></strong>
                            <?php if($course->isDownloadable()): ?>
                                <div class="mt-20 d-flex align-items-center text-gray">
                                    ...
                                    <span
                                        class="ml-5 font-14 font-weight-500"><?php echo e(trans('webinars.downloadable_content')); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($course->certificate or $course->quizzes->where('certificate', 1)->count() > 0): ?>
                                <div class="mt-20 d-flex align-items-center text-gray">
                                    ...
                                    <span
                                        class="ml-5 font-14 font-weight-500"><?php echo e(trans('webinars.official_certificate')); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($course->quizzes->where('status', \App\models\Quiz::ACTIVE)->count() > 0): ?>
                                <div class="mt-20 d-flex align-items-center text-gray">
                                    ...
                                    <span
                                        class="ml-5 font-14 font-weight-500"><?php echo e(trans('webinars.online_quizzes_count', ['quiz_count' => $course->quizzes->where('status', \App\models\Quiz::ACTIVE)->count()])); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($course->support): ?>
                                <div class="mt-20 d-flex align-items-center text-gray">
                                    ...
                                    <span
                                        class="ml-5 font-14 font-weight-500"><?php echo e(trans('webinars.instructor_support')); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-40 p-10 rounded-sm border row align-items-center favorites-share-box">
                            <?php if($course->isWebinar()): ?>
                                <div class="col">
                                    <a href="<?php echo e($course->addToCalendarLink()); ?>" target="_blank"
                        ...
                        <div class="mt-30 text-center">
                            <button type="button" id="webinarReportBtn"
                                class="font-14 text-gray btn-transparent"><?php echo e(trans('webinars.report_this_webinar')); ?></button>
                        </div>
                    </div>
                </div>
                ...
                <?php if(
                    ...
                    <a href="/gift/course/<?php echo e($course->slug); ?>"
                        ...
                        <?php if(!empty($course->access_days)): ?>
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span
                                        class="ml-5 font-14 font-weight-500"><?php echo e(trans('update.access_period')); ?>:</span>
                                </div>
                ...
                <?php if($course->creator_id != $course->teacher_id): ?>
                    <?php echo $__env->make('web.default.course.sidebar_instructor_profile', [
                    ...
                    <div class="rounded-lg tags-card shadow-sm mt-35 px-25 py-20">
                        ...
                        <div class="d-flex flex-wrap mt-10">
                            <?php $__currentLoopData = $course->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="/tags/courses/<?php echo e(urlencode($tag->title)); ?>"
                                    class="tag-item bg-gray200 p-5 font-14 text-gray font-weight-500 rounded"><?php echo e($tag->title); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/course/index.blade.php ENDPATH**/ ?>