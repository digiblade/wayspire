            ...
            <form action="<?php echo e(getAdminPanelUrl()); ?>/settings/main" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="value[register_method]" class="form-control">
                        ...
                        <option><?php echo e(trans('admin/main.sms')); ?> (Paid Plugin)</option>
                    </select>
                </div>
...
<?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/admin/settings/general/basic.blade.php ENDPATH**/ ?>