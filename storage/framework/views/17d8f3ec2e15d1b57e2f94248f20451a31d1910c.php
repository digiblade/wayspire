...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="row login-container" style="background-color:white !important">
                                ...
                                <div class="d-flex align-items-center wizard-custom-radio mt-5">
                                    <div class="wizard-custom-radio-item flex-grow-1">
                                        <input type="radio" name="account_type" value="user" id="role_user"
                                            class=""
                                            <?php echo e((empty($oldAccountType) or $oldAccountType == 'user') ? 'checked' : ''); ?>>
                                    ...
                                    <?php $__currentLoopData = $selectRolesDuringRegistration; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selectRole): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="wizard-custom-radio-item flex-grow-1">
                                            <input type="radio" name="account_type" value="<?php echo e($selectRole); ?>"
                                                id="role_<?php echo e($selectRole); ?>" class=""
                                                <?php echo e($oldAccountType == $selectRole ? 'checked' : ''); ?>>
                                            <label class="font-12 cursor-pointer px-15 py-10"
                                                for="role_<?php echo e($selectRole); ?>"><?php echo e(trans('update.role_' . $selectRole)); ?></label>
                                        </div>
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/auth/register.blade.php ENDPATH**/ ?>