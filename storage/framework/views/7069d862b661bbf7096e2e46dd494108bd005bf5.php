        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_notifications_list')): ?>
                    ...
                    <div class="dropdown-list-icons mb-0" height="150px">
                        <a href="https://codecanyon.net/user/rocketsoft/portfolio" class="dropdown-item">
                            ...
                            <div class="dropdown-item-desc">
                                Wayspire
                                <div class="time text-primary">All rights reserved for Digiblade</div>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <li class="dropdown dropdown-list-toggle">
                <a href="#" data-toggle="dropdown"
                    class="nav-link notification-toggle nav-link-lg <?php if(!empty($unreadNotifications) and count($unreadNotifications)): ?> beep <?php else: ?> disabled <?php endif; ?>">
                    ...
                    <div class="dropdown-header"><?php echo e(trans('admin/main.notifications')); ?>
                        ...
                        <div class="float-right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_notifications_markAllRead')): ?>
                                <a
                                    href="<?php echo e(getAdminPanelUrl()); ?>/notifications/mark_all_read"><?php echo e(trans('admin/main.mark_all_read')); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                            ...
                            <a href="<?php echo e(getAdminPanelUrl()); ?>/notifications" class="dropdown-item">
                                ...
                                <div class="dropdown-item-desc">
                                    ...
                                    <div class="time text-primary">
                                        <?php echo e(dateTimeFormat($unreadNotification->created_at, 'Y M j | H:i')); ?></div>
                                </div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="dropdown-footer text-center">
                        <a href="<?php echo e(getAdminPanelUrl()); ?>/notifications"><?php echo e(trans('admin/main.view_all')); ?> <i
...
<?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/admin/includes/navbar.blade.php ENDPATH**/ ?>