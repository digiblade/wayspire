...
<?php $__env->startSection('content'); ?>
    <section>
        <h2 class="section-title text-light"><?php echo e(trans('panel.my_activity')); ?></h2>
            ...
            <div class="row">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong
                            class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e(convertMinutesToHourAndMinute($hours)); ?></strong>
                            ...
                            <div class="webinar-card webinar-list d-flex">
                                <div class="image-box">
                                    ...
                                    <?php if(!empty($sale->webinar)): ?>
                                        <div class="badges-lists">
                                            <?php if($item->type == 'webinar'): ?>
                                                <?php if($item->start_date > time()): ?>
                                                    <span
                                                        class="badge badge-primary"><?php echo e(trans('panel.not_conducted')); ?></span>
                                                <?php elseif($item->isProgressing()): ?>
                                                    <span
                                                        class="badge badge-secondary"><?php echo e(trans('webinars.in_progress')); ?></span>
                                                <?php else: ?>
                                                    <span
                                            ...
                                            <?php else: ?>
                                                <span
                                                    class="badge badge-secondary"><?php echo e(trans('webinars.' . $item->type)); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <?php
                                            ...
                                            if ($item->isWebinar()) {
                                                if ($item->isProgressing()) {
                                                    $progressTitle = trans('public.course_learning_passed', [
                                                        'percent' => $percent,
                                                    ]);
                                                } else {
                                                    $progressTitle =
                                        ...
                                        <?php else: ?>
                                            <div class="progress cursor-pointer" data-toggle="tooltip" data-placement="top"
                                                title="<?php echo e($progressTitle); ?>">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <h3 class="webinar-title font-weight-bold font-16 text-dark-blue">
                                                ...
                                                <?php if(!empty($item->access_days)): ?>
                                                    <?php if(!$item->checkHasExpiredAccessDays($sale->created_at, $sale->gift_id)): ?>
                                                        <span
                                                            class="badge badge-outlined-danger ml-10"><?php echo e(trans('update.access_days_expired')); ?></span>
                                                    <?php else: ?>
                                                        <span
                                                            class="badge badge-outlined-warning ml-10"><?php echo e(trans('update.expired_on_date', ['date' => dateTimeFormat($item->getExpiredAccessDays($sale->created_at, $sale->gift_id), 'j M Y')])); ?></span>
                                                    <?php endif; ?>
                                                <?php endif; ?>

                                                <?php if(
                                                    $sale->payment_method == \App\Models\Sale::$subscribe and
                                                        $sale->checkExpiredPurchaseWithSubscribe(
                                                            $sale->buyer_id,
                                                            $item->id,
                                                            !empty($sale->webinar) ? 'webinar_id' : 'bundle_id')): ?>
                                                    <span
                                                        class="badge badge-outlined-danger ml-10"><?php echo e(trans('update.subscribe_expired')); ?></span>
                                                <?php endif; ?>

                                                <?php if(!empty($sale->webinar)): ?>
                                                    <span
                                                        class="badge badge-dark ml-10 status-badge-dark"><?php echo e(trans('webinars.' . $item->type)); ?></span>
                                                <?php endif; ?>

                                                <?php if(!empty($sale->gift_id)): ?>
                                                    <span
                                                        class="badge badge-primary ml-10"><?php echo e(trans('update.gift')); ?></span>
                                                <?php endif; ?>
                                            </h3>
                                        </a>
                                        ...
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu">
                                                <?php if(!empty($sale->gift_id) and $sale->buyer_id == $authUser->id): ?>
                                                    <a href="/panel/webinars/<?php echo e($item->id); ?>/sale/<?php echo e($sale->id); ?>/invoice"
                                                        target="_blank"
                                                        class="webinar-actions d-block mt-10"><?php echo e(trans('public.invoice')); ?></a>
                                                <?php else: ?>
                                                    <?php if(!empty($item->access_days) and !$item->checkHasExpiredAccessDays($sale->created_at, $sale->gift_id)): ?>
                                                        <a href="<?php echo e($item->getUrl()); ?>" target="_blank"
                                                            class="webinar-actions d-block mt-10"><?php echo e(trans('update.enroll_on_course')); ?></a>
                                                    <?php elseif(!empty($sale->webinar)): ?>
                                                        <a href="<?php echo e($item->getLearningPageUrl()); ?>" target="_blank"
                                                            class="webinar-actions d-block"><?php echo e(trans('update.learning_page')); ?></a>

                                                        <?php if(!empty($item->start_date) and ($item->start_date > time() or $item->isProgressing() and !empty($nextSession))): ?>
                                                            <button type="button" data-webinar-id="<?php echo e($item->id); ?>"
                                                                class="join-purchase-webinar webinar-actions btn-transparent d-block mt-10"><?php echo e(trans('footer.join')); ?></button>
                                                        <?php endif; ?>
                                                    ...
                                                    <a href="<?php echo e($item->getUrl()); ?>?tab=reviews" target="_blank"
                                                        class="webinar-actions d-block mt-10"><?php echo e(trans('public.feedback')); ?></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="webinar-price-box mt-15">
                                        <?php if($item->price > 0): ?>
                                            <?php if($item->bestTicket() < $item->price): ?>
                                                <span
                                                    class="real"><?php echo e(handlePrice($item->bestTicket(), true, true, false, null, true)); ?></span>
                                                <span
                                                    class="off ml-10"><?php echo e(handlePrice($item->price, true, true, false, null, true)); ?></span>
                                            <?php else: ?>
                                                <span
                                                    class="real"><?php echo e(handlePrice($item->price, true, true, false, null, true)); ?></span>
                                            <?php endif; ?>
                                        <?php else: ?>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                        ...
                                        <?php if(!empty($sale->gift_id) and $sale->buyer_id == $authUser->id): ?>
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                ...
                                                <?php if(!empty($sale->gift_date) and $sale->gift_date > time()): ?>
                                                    <span
                                                        class="stat-value text-warning"><?php echo e(trans('public.pending')); ?></span>
                                                <?php else: ?>
                                        ...
                                        <?php if(!empty($sale->gift_id)): ?>
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                ...
                                                <span
                                                    class="stat-value"><?php echo e(!empty($sale->gift_date) ? dateTimeFormat($sale->gift_date, 'j M Y H:i') : trans('update.instantly')); ?></span>
                                            </div>
                                        <?php else: ?>
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                <span class="stat-title"><?php echo e(trans('public.category')); ?>:</span>
                                                <span
                                                    class="stat-value"><?php echo e(!empty($item->category_id) ? $item->category->title : ''); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(!empty($sale->webinar) and $item->type == 'webinar'): ?>
                                            <?php if($item->isProgressing() and !empty($nextSession)): ?>
                                                <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                    <span
                                                        class="stat-title"><?php echo e(trans('webinars.next_session_duration')); ?>:</span>
                                                    <span
                                                        class="stat-value"><?php echo e(convertMinutesToHourAndMinute($nextSession->duration)); ?>
                                                ...
                                                <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                    <span
                                                        class="stat-title"><?php echo e(trans('webinars.next_session_start_date')); ?>:</span>
                                                    <span
                                            ...
                                            <?php else: ?>
                                                <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                    ...
                                                    <span
                                                        class="stat-value"><?php echo e(convertMinutesToHourAndMinute($item->duration)); ?>
                                                ...
                                                <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                    ...
                                                    <span
                                                        class="stat-value"><?php echo e(dateTimeFormat($item->start_date, 'j M Y')); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        <?php elseif(!empty($sale->bundle)): ?>
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                <span class="stat-title"><?php echo e(trans('public.duration')); ?>:</span>
                                                <span
                                                    class="stat-value"><?php echo e(convertMinutesToHourAndMinute($item->getBundleDuration())); ?>
                                        ...
                                        <?php else: ?>
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                ...
                                                <span
                                                    class="stat-value"><?php echo e(dateTimeFormat($sale->created_at, 'j M Y')); ?></span>
                                            </div>
                                        <?php endif; ?>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/panel/webinar/purchases.blade.php ENDPATH**/ ?>