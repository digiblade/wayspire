<div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
    ...
    <?php if(!empty($webinarPartnerTeacher)): ?>
        <span
            class="user-select-none px-15 py-10 bg-gray200 off-label text-gray text-white font-12 rounded-sm ml-auto"><?php echo e(trans('public.invited')); ?></span>
    <?php endif; ?>
    ...
    <div class="user-reward-badges d-flex flex-wrap align-items-center mt-20">
        <?php $__currentLoopData = $courseTeacher->getBadges(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userBadge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="mr-15 mt-10" data-toggle="tooltip" data-placement="bottom" data-html="true"
                title="<?php echo !empty($userBadge->badge_id) ? nl2br($userBadge->badge->description) : nl2br($userBadge->description); ?>">
                <img src="<?php echo e(!empty($userBadge->badge_id) ? $userBadge->badge->image : $userBadge->image); ?>"
                    width="32" height="32"
                    alt="<?php echo e(!empty($userBadge->badge_id) ? $userBadge->badge->title : $userBadge->title); ?>">
            </div>
    ...
    <div class="mt-25 d-flex flex-row align-items-center justify-content-center w-100">
        <a href="<?php echo e($courseTeacher->getProfileUrl()); ?>" target="_blank"
            class="btn btn-sm btn-primary <?php echo e($hasMeeting ? 'teacher-btn-action' : 'btn-block'); ?>"><?php echo e(trans('public.profile')); ?></a>

        
    </div>
</div>
<?php /**PATH /Volumes/Datagram/__MACOSX/resources/views/web/default/course/sidebar_instructor_profile.blade.php ENDPATH**/ ?>