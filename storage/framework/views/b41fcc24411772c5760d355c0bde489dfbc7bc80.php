...
<head>
    ...
    <title>
        <?php echo e($pageTitle ?? ''); ?><?php echo e(!empty($generalSettings['site_name']) ? ' | ' . $generalSettings['site_name'] : ''); ?>
    ...
    <style>
        <?php echo !empty(getCustomCssAndJs('css')) ? getCustomCssAndJs('css') : ''; ?> <?php echo getThemeFontsSettings(); ?> <?php echo getThemeColorsSettings(); ?>
...
<?php /**PATH /home/oxlircor/wayspire-dev.oxlide.co.in/resources/views/web/default/layouts/app.blade.php ENDPATH**/ ?>