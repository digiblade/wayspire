...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong
                            class="font-30 font-weight-bold text-dark-blue mt-5"><?php echo e(handlePrice($sumReservePaid)); ?></strong>
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong
                            class="font-30 font-weight-bold text-dark-blue mt-5"><?php echo e(convertMinutesToHourAndMinute($activeHoursCount / 60)); ?></strong>
                                        ...
                                        <select name="student_id" class="form-control select2 ">
                                            ...
                                            <?php $__currentLoopData = $usersReservedTimes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($student->id); ?>"
                                                    <?php if(request()->get('student_id') == $student->id): ?> selected <?php endif; ?>>
    ...
    <section class="mt-35 pb-50 mb-50 bg-light p-2 rounded">
        <form action="/panel/meetings/requests?<?php echo e(http_build_query(request()->all())); ?>" method="get"
            ...
            <div
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="open_meetings"
                        <?php echo e(request()->get('open_meetings', '') == 'on' ? 'checked' : ''); ?>
        ...
        <?php if($reserveMeetings->count() > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $reserveMeetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ReserveMeeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-left">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    <div class="avatar bg-gray200">
                                                        <img src="<?php echo e($ReserveMeeting->user->getAvatar()); ?>"
                                                            class="img-cover" alt="">
                                                    </div>
                                                    <div class=" ml-5">
                                                        <span
                                                            class="d-block font-weight-500"><?php echo e($ReserveMeeting->user->full_name); ?></span>
                                                        <span
                                                            class="mt-5 font-12 text-gray d-block"><?php echo e($ReserveMeeting->user->email); ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="font-weight-500 align-middle">
                                                <?php echo e(handlePrice($ReserveMeeting->paid_amount)); ?></td>
                                            ...
                                            <td class="align-middle">
                                                <?php switch($ReserveMeeting->status):
                                                    ...
                                                    <?php case (\App\Models\ReserveMeeting::$open): ?>
                                                        <span
                                                            class="text-primary font-weight-500"><?php echo e(trans('public.open')); ?></span>
                                                    <?php break; ?>
            ...
            <div class="my-30 bg-light p-2 rounded">
    ...
    <div class="d-none" id="liveMeetingLinkModal">
        ...
        <form action="/panel/meetings/create-link" method="post">
            ...
            <div class="mt-30 d-flex align-items-center justify-content-end">
                <button type="button"
                    class="js-save-meeting-link btn btn-sm btn-primary"><?php echo e(trans('public.save')); ?></button>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/panel/meeting/requests.blade.php ENDPATH**/ ?>