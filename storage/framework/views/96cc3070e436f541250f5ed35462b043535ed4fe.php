<?php $__env->startSection('content'); ?>
    <section class="cart-banner position-relative text-center text-light">
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    ...
                    <div
                        class="d-flex flex-column flex-sm-row align-items-center align-sm-items-start justify-content-between">
                            ...
                            <span class="mt-10 mt-md-20 font-16 font-weight-500 text-white"><?php echo e(trans('public.created_by')); ?>
                                ...
                                <?php if($post->author->isTeacher()): ?>
                                    <a href="<?php echo e($post->author->getProfileUrl()); ?>" target="_blank"
                                        class="text-white text-decoration-underline"><?php echo e($post->author->full_name); ?></a>
                        ...
                        <span class="mt-10 mt-md-20 font-16 font-weight-500 text-white"><?php echo e(trans('public.in')); ?>
                            ...
                            <a href="<?php echo e($post->category->getUrl()); ?>"
                                class="text-white text-decoration-underline"><?php echo e($post->category->title); ?></a>
                        </span>

                        <span
                            class="mt-10 mt-md-20 font-16 font-weight-500 text-white"><?php echo e(dateTimeFormat($post->created_at, 'j M Y')); ?></span>
            ...
            <div class="col-12 col-lg-4">
                <?php if(!empty($post->author) and !empty($post->author->full_name)): ?>
                    <div
                        ...
                        <div class="mt-25 d-flex align-items-center  w-100">
                            <a href="/blog?author=<?php echo e($post->author->id); ?>"
                                class="btn btn-sm btn-primary btn-block px-15"><?php echo e(trans('public.author_posts')); ?></a>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="p-20 mt-30 rounded-sm shadow-lg border border-gray300 bg-light">
                    <h3 class=" category-filter-title text-light font-16 font-weight-bold text-dark-blue">
                        <?php echo e(trans('categories.categories')); ?></h3>
                    ...
                    <div class="pt-15">
                        <?php $__currentLoopData = $blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blogCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($blogCategory->getUrl()); ?>"
                                class="font-14 text-dark-blue d-block mt-15"><?php echo e($blogCategory->title); ?></a>
                ...
                <div class="p-20 mt-30 rounded-sm shadow-lg border border-gray300 bg-light">
                    <h3 class=" category-filter-title text-light font-20 font-weight-bold text-dark-blue">
                        <?php echo e(trans('site.recent_posts')); ?></h3>
                        ...
                        <?php $__currentLoopData = $popularPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popularPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="popular-post d-flex align-items-start mt-20">
                                <div class="popular-post-image rounded">
                                    <img src="<?php echo e($popularPost->image); ?>" class="img-cover rounded"
                                        alt="<?php echo e($popularPost->title); ?>">
                                </div>
                                <div class="popular-post-content d-flex flex-column ml-10">
                                    ...
                                    <span
                                        class="mt-auto font-12 text-gray"><?php echo e(dateTimeFormat($popularPost->created_at, 'j M Y')); ?></span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                        <a href="/blog" class="btn btn-sm btn-primary btn-block mt-30"><?php echo e(trans('home.view_all')); ?>

                            <?php echo e(trans('site.posts')); ?></a>
                    </div>
                </div>
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/blog/show.blade.php ENDPATH**/ ?>