                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="btn-group dropdown table-actions">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="/panel/webinars/favorites/<?php echo e($favorite->id); ?>/delete"
                                                class="webinar-actions d-block delete-action"><?php echo e(trans('public.remove')); ?></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="webinar-price-box mt-15">
                                    <?php if(empty($favorite->upcoming_course_id) and $favItem->bestTicket() < $favItem->price): ?>
                                        <span
                                            class="real"><?php echo e(handlePrice($favItem->bestTicket(), true, true, false, null, true)); ?></span>
                                        <span
                                            class="off ml-10"><?php echo e(handlePrice($favItem->price, true, true, false, null, true)); ?></span>
                                    <?php else: ?>
                                        <span
                                            class="real"><?php echo e(handlePrice($favItem->price, true, true, false, null, true)); ?></span>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        ...
                                        <span
                                            class="stat-value"><?php echo e(!empty($favItem->category_id) ? $favItem->category->title : ''); ?></span>
                                    </div>

                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        <span class="stat-title"><?php echo e(trans('public.duration')); ?>:</span>
                                        <span class="stat-value"><?php echo e(convertMinutesToHourAndMinute($favItem->duration)); ?>
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        ...
                                        <span
                                            class="stat-value"><?php echo e(dateTimeFormat(!empty($favItem->start_date) ? $favItem->start_date : $favItem->created_at, 'j M Y')); ?></span>
                                    </div>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/panel/webinar/favorites.blade.php ENDPATH**/ ?>