                                        ...
                                        <tr>
                                            <td class="text-left align-middle" width="35%">
                                                <a class="text-dark-blue font-weight-500"
                                                    href="<?php echo e($comment->webinar->getUrl()); ?>"
                                                    target="_blank"><?php echo e($comment->webinar->title); ?></a>
                                            </td>
                                            <td class="align-middle">
                                                <button type="button" data-comment-id="<?php echo e($comment->id); ?>"
                                                    class="js-view-comment btn btn-sm btn-gray200"><?php echo e(trans('public.view')); ?></button>
                                            </td>

                                            <td class="align-middle">
                                                <?php if($comment->status == 'active'): ?>
                                                    <span
                                                        class="text-primary text-dark-blue font-weight-500"><?php echo e(trans('public.published')); ?></span>
                                                <?php else: ?>
                                                    <span
                                                        class="text-warning text-dark-blue font-weight-500"><?php echo e(trans('public.pending')); ?></span>
                                                <?php endif; ?>
                                            </td>

                                            <td class="text-dark-blue font-weight-500 align-middle">
                                                <?php echo e(dateTimeFormat($comment->created_at, 'j M Y | H:i')); ?></td>
                                            <td class="align-middle text-right">
                                                <input type="hidden" id="commentDescription<?php echo e($comment->id); ?>"
                                                    value="<?php echo e(nl2br($comment->comment)); ?>">
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <button type="button" data-comment-id="<?php echo e($comment->id); ?>"
                                                            class="js-edit-comment btn-transparent"><?php echo e(trans('public.edit')); ?></button>
                                                        <a href="/panel/webinars/comments/<?php echo e($comment->id); ?>/delete"
                                                            class="delete-action btn-transparent d-block mt-10"><?php echo e(trans('public.delete')); ?></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/panel/webinar/my_comments.blade.php ENDPATH**/ ?>