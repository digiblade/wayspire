                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="quiz_or_webinar" class="form-control"
                                    value="<?php echo e(request()->get('quiz_or_webinar', '')); ?>" />
                            </div>
                        </div>
                                ...
                                <div class="col-12 col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="instructor" class="form-control"
                                            value="<?php echo e(request()->get('instructor', '')); ?>" />
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="passed"
                                                <?php echo e(request()->get('status') === 'passed' ? 'selected' : ''); ?>>
                                                <?php echo e(trans('quiz.passed')); ?></option>
                                            <option value="failed"
                                                <?php echo e(request()->get('status') === 'failed' ? 'selected' : ''); ?>>
                                                <?php echo e(trans('quiz.failed')); ?></option>
                                            <option value="waiting"
                                                <?php echo e(request()->get('status') === 'waiting' ? 'selected' : ''); ?>>
                                                <?php echo e(trans('quiz.waiting')); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
            ...
            <form action="" method="get">
                <div
                    ...
                    <label class="mb-0 mr-10 cursor-pointer font-14 text-gray font-weight-500"
                        for="onlyOpenQuizzesSwitch"><?php echo e(trans('quiz.show_only_open_results')); ?></label>
                    <div class="custom-control custom-switch">
                        <input type="checkbox" name="open_results" <?php if(request()->get('open_results', '') == 'on'): ?> checked <?php endif; ?>
                                    ...
                                    <?php $__currentLoopData = $quizzesResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-left">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    <div class="avatar bg-gray200">
                                                        <img src="<?php echo e($result->quiz->creator->getAvatar()); ?>"
                                                            class="img-cover" alt="">
                                                    </div>
                                                    <div class=" ml-5">
                                                        <span
                                                            class="d-block"><?php echo e($result->quiz->creator->full_name); ?></span>
                                                        <span
                                                            class="mt-5 font-12 text-gray d-block"><?php echo e($result->quiz->creator->email); ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-left">
                                                ...
                                                <span
                                                    class="font-12 text-gray d-block"><?php echo e($result->quiz->webinar->title); ?></span>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <span
                                                    class="d-block text-<?php echo e($result->status == 'passed' ? 'primary' : ($result->status == 'waiting' ? 'warning' : 'danger')); ?>">
                                                ...
                                                <?php if($result->status == 'failed' and $result->can_try): ?>
                                                    <span
                                                        class="d-block font-12 text-gray"><?php echo e(trans('quiz.quiz_chance_remained', ['count' => $result->count_can_try])); ?></span>
                                                <?php endif; ?>
                                            </td>

                                            <td class="align-middle">
                                                <?php echo e(dateTimeFormat($result->created_at, 'j M Y H:i')); ?>
                                                ...
                                                <div
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <?php if(!$result->can_try and $result->status != 'waiting' or $result->status == 'passed'): ?>
                                                            <a href="/panel/quizzes/<?php echo e($result->id); ?>/result"
                                                                class="webinar-actions d-block mt-10"><?php echo e(trans('public.view_answers')); ?></a>
                                                        <?php endif; ?>

                                                        <?php if($result->status != 'passed'): ?>
                                                            <?php if($result->can_try): ?>
                                                                <a href="/panel/quizzes/<?php echo e($result->quiz->id); ?>/start"
                                                                    class="webinar-actions d-block mt-10"><?php echo e(trans('public.try_again')); ?></a>
                                                            <?php endif; ?>
                                                        <?php endif; ?>

                                                        <a href="<?php echo e($result->quiz->webinar->getUrl()); ?>"
                                                            class="webinar-actions d-block mt-10"><?php echo e(trans('webinars.webinar_page')); ?></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/panel/quizzes/my_results.blade.php ENDPATH**/ ?>