        ...
        <div class="form-group">
            ...
            <select name="country_code" class="form-control select2">
                <?php $__currentLoopData = getCountriesMobileCode(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country => $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($code); ?>" <?php if($code == old('country_code')): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-7">
        <div class="form-group">
            <label class="input-label" for="mobile"><?php echo e(trans('auth.mobile')); ?>

                <?php echo e(!empty($optional) ? '(' . trans('public.optional') . ')' : ''); ?>:</label>
...
<?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/auth/register_includes/mobile_field.blade.php ENDPATH**/ ?>