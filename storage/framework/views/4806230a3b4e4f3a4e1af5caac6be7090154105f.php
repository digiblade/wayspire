                    ...
                    <div class="col-12 col-md-8  container mt-5">
                        <div id="autoCarousel" class="custom-carousel">
                            ...
                            <div class="custom-carousel-indicators">
                                <?php $__currentLoopData = $carousel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bestSaleWebinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" data-slide-to="<?php echo e($index); ?>"
                                    ...
                                    <div class="custom-carousel-item active p-0 p-md-4 " style="display:flex;">
                                        <div class="custom-carousel-caption"
                                            ...
                                            <h2 class="fw-bold" style="font-size:2rem">
                                                <?php echo e($bestSaleWebinar->category->title); ?></h2>
                                            <p><?php echo e($bestSaleWebinar->title); ?></p>
                                            <a style="background-color:#f97316; border-radius:2rem; padding:0.4rem 0.8rem; width:min-content;text-wrap:nowrap"
                                                href="<?php echo e($bestSaleWebinar->getUrl()); ?>" class=" mt-24"
                                                style="margin: 2rem 0">View Courses
                                                →</a>
                                        </div>
                                        <img style="width:50%" src="<?php echo e($bestSaleWebinar->getImage()); ?>" alt="Slide 1">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Datagram/__MACOSX/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>