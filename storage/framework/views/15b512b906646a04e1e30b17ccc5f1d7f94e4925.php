<div class="mt-35">
    <h2 class="section-title after-line text-light"><?php echo e(trans('panel.comments')); ?> <span
            class="ml-5">(<?php echo e($comments->count()); ?>)</span></h2>
...
unset($__errorArgs, $__bag); ?>
            ...
            <button type="submit" class="btn btn-sm btn-primary bg-blue"><?php echo e(trans('product.post_comment')); ?></button>
        </form>
    </div>
    ...
    <?php if($comments): ?>
        <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="comments-card shadow-lg rounded-sm border px-20 py-15 mt-30"
                data-address="/comments/<?php echo e($comment->id); ?>/reply" data-csrf="<?php echo e(csrf_token()); ?>"
                ...
                <div class="d-flex align-items-center justify-content-between">
                            ...
                            <span class="font-12 text-gray">
                                <?php if(
                                    !$comment->user->isUser() and
                                        !empty($course) and
                                        ($course->creator_id == $comment->user_id or $course->teacher_id == $comment->user_id)): ?>
                    ...
                    <div class="d-flex align-items-center">
                        <span
                            class="font-12 text-gray mr-10"><?php echo e(dateTimeFormat($comment->created_at, 'j M Y | H:i')); ?></span>
                        ...
                        <div class="btn-group dropdown table-actions">
                            ...
                            <div class="dropdown-menu">
                                <button type="button"
                                    class="btn-transparent webinar-actions d-block text-hover-primary reply-comment"><?php echo e(trans('panel.reply')); ?></button>
                                <button type="button" data-item-id="<?php echo e($inputValue); ?>"
                                    data-comment-id="<?php echo e($comment->id); ?>"
                                    class="btn-transparent webinar-actions d-block mt-10 text-hover-primary report-comment"><?php echo e(trans('panel.report')); ?></button>

                                <?php if(auth()->check() and auth()->user()->id == $comment->user_id): ?>
                                    <a href="/comments/<?php echo e($comment->id); ?>/delete"
                                        class="webinar-actions d-block mt-10 text-hover-primary"><?php echo e(trans('public.delete')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rounded-sm border px-20 py-15 mt-30">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="user-inline-avatar d-flex align-items-center mt-10">
                                    ...
                                    <div class="d-flex flex-column ml-5">
                                        <span
                                            class="font-weight-500 text-secondary"><?php echo e($reply->user->full_name); ?></span>
                                        <span class="font-12 text-gray">
                                            <?php if(
                                                !$reply->user->isUser() and
                                                    !empty($course) and
                                                    ($course->creator_id == $reply->user_id or $course->teacher_id == $reply->user_id)): ?>
                                                <?php echo e(trans('panel.teacher')); ?>
                                ...
                                <div class="d-flex align-items-center">
                                    <span
                                        class="font-12 text-gray mr-10"><?php echo e(dateTimeFormat($reply->created_at, 'j M Y | H:i')); ?></span>
                                    ...
                                    <div class="btn-group dropdown table-actions">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <?php if(auth()->check() and auth()->user()->id == $reply->user_id): ?>
                                                <a href="/comments/<?php echo e($reply->id); ?>/delete"
                                                    class="webinar-actions d-block mt-10 text-hover-primary"><?php echo e(trans('public.delete')); ?></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
...
<?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/includes/comments.blade.php ENDPATH**/ ?>