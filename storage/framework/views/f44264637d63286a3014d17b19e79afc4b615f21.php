...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="row login-container" style="background-color:white">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex align-items-center mt-20 p-15 danger-transparent-alert ">
                            ...
                            <div class="ml-10">
                                <div class="font-14 font-weight-bold ">
                                    <?php echo e(session()->get('login_failed_active_session')['title']); ?></div>
                    ...
                    <div class="text-center mt-20">
                        <span
                            class="badge badge-circle-gray300 text-secondary d-inline-flex align-items-center justify-content-center"><?php echo e(trans('auth.or')); ?></span>
                    </div>
                    ...
                    <?php if(!empty(getFeaturesSettings('show_facebook_login_button'))): ?>
                        <a href="<?php echo e(url('/facebook/redirect')); ?>" target="_blank"
                            class="social-login mt-20 p-10 text-center d-flex align-items-center justify-content-center ">
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/auth/login.blade.php ENDPATH**/ ?>