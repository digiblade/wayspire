<?php if(!empty($authUser)): ?>
    ...
    <div class="custom-dropdown navbar-auth-user-dropdown position-relative ml-50">
        <div class="custom-dropdown-toggle d-flex align-items-center navbar-user cursor-pointer">
            <img src="<?php echo e($authUser->getAvatar()); ?>" class="rounded-circle" style="height:20px" alt="<?php echo e($authUser->full_name); ?>">
        ...
        <div class="custom-dropdown-body pb-10">
            ...
            <div class="dropdown-user-avatar d-flex align-items-center p-15 m-15 mb-10 rounded-sm border">
                <div class="size-40 rounded-circle position-relative">
                    <img src="<?php echo e($authUser->getAvatar()); ?>" class="img-cover rounded-circle"
...
<?php else: ?>
    <div class="d-flex align-items-center ml-md-50">
        <a href="/login" class="py-5 px-10 mr-10 text-light font-14"><?php echo e(trans('auth.login')); ?></a>
        <a href="/register" class="py-5 px-10 text-light  font-14"><?php echo e(trans('auth.register')); ?></a>
    </div>
<?php endif; ?>
<?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/includes/top_nav/user_menu.blade.php ENDPATH**/ ?>