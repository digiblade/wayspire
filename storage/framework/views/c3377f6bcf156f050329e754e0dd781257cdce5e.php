            ...
            <form action="<?php echo e(getAdminPanelUrl()); ?>/settings/features" method="post">
                ...
                <div class="form-group mt-3 custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        <input type="hidden" name="value[content_translate]" value="0">
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="contentTranslate"><?php echo e(trans('update.attachment')); ?></label>
                    </label>
                    <div class="text-muted text-small mt-1">Paid Plugin</div>
                </div>
...
<?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/admin/settings/general/features.blade.php ENDPATH**/ ?>