...
<?php $__env->startSection('content'); ?>
    ...
    <form class="bg-light my-2 p-2 rounded-sm" method="post" id="userSettingForm" class="mt-30"
        action="<?php echo e(!empty($new_user) ? '/panel/manage/' . $user_type . '/new' : '/panel/setting'); ?>">
        ...
        <div class="d-flex align-items-center">
            <?php if(!empty($user) and empty($new_user)): ?>
                <?php if(!empty($currentStep) and $currentStep > 1): ?>
                    <a href="/panel/setting/step/<?php echo e($currentStep - 1); ?>"
                        class="btn btn-sm btn-primary"><?php echo e(trans('webinars.previous')); ?></a>
                <?php else: ?>
                ...
                <button type="button" id="getNextStep" class="btn btn-sm btn-primary ml-15"
                    <?php if(!empty($currentStep) and ($user->isUser() and $currentStep == 7 or !$user->isUser() and $currentStep == 8)): ?> disabled <?php endif; ?>><?php echo e(trans('webinars.next')); ?></button>
            <?php endif; ?>
        </div>
        ...
        <div class="d-flex align-items-center">
            <?php if(empty($new_user) and empty($edit_new_user)): ?>
                <a href="/panel/setting/deleteAccount" class="delete-action btn btn-sm btn-danger"
                    data-confirm="<?php echo e(trans('update.delete_account_modal_confirm_btn_text')); ?>"
                    data-title="<?php echo e(trans('update.delete_account_modal_hint')); ?>"><?php echo e(trans('update.delete_account')); ?></a>
            <?php endif; ?>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/panel/setting/index.blade.php ENDPATH**/ ?>