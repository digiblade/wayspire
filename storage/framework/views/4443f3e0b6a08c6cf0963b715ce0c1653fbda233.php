    ...
    <div class="row align-items-center text-light">
        <div class="col-lg-3 d-flex align-items-center">
            <div class="checkbox-button primary-selected">
                <input type="radio" name="card" id="gridView" value="grid"
                    <?php if(empty(request()->get('card')) or request()->get('card') == 'grid'): ?> checked="checked" <?php endif; ?>>
                <label for="gridView" class="bg-white border-0 mb-0">
                    <i data-feather="grid" width="25" height="25"
                        class="<?php if(empty(request()->get('card')) or request()->get('card') == 'grid'): ?> text-primary <?php endif; ?>"></i>
                </label>
            </div>

            <div class="checkbox-button primary-selected ml-10">
                <input type="radio" name="card" id="listView" value="list"
                    <?php if(!empty(request()->get('card')) and request()->get('card') == 'list'): ?> checked="checked" <?php endif; ?>>
                <label for="listView" class="bg-white border-0 mb-0">
                    <i data-feather="list" width="25" height="25"
                        class="<?php echo e((!empty(request()->get('card')) and request()->get('card') == 'list') ? 'text-primary' : ''); ?>"></i>
                </label>
            </div>
        </div>
            ...
            <div
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="upcoming" class="custom-control-input" id="upcoming"
                        <?php if(request()->get('upcoming', null) == 'on'): ?> checked="checked" <?php endif; ?>>
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center">
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="free" class="custom-control-input" id="free"
                        <?php if(request()->get('free', null) == 'on'): ?> checked="checked" <?php endif; ?>>
            ...
            <div
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="discount" class="custom-control-input" id="discount"
                        <?php if(request()->get('discount', null) == 'on'): ?> checked="checked" <?php endif; ?>>
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center">
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="downloadable" class="custom-control-input" id="download"
                        <?php if(request()->get('downloadable', null) == 'on'): ?> checked="checked" <?php endif; ?>>
        ...
        <div class="col-lg-3 d-flex align-items-center">
            <select name="sort" class="form-control font-14">
                ...
                <option value="inexpensive" <?php if(request()->get('sort', null) == 'inexpensive'): ?> selected="selected" <?php endif; ?>>
                    <?php echo e(trans('public.inexpensive')); ?></option>
                <option value="bestsellers" <?php if(request()->get('sort', null) == 'bestsellers'): ?> selected="selected" <?php endif; ?>>
...
<?php /**PATH /home/oxlircor/wayspire-dev.oxlide.co.in/resources/views/web/default/pages/includes/top_filters.blade.php ENDPATH**/ ?>