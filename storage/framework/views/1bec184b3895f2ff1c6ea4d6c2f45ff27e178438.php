                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="publish" <?php if(request()->get('status') == 'publish'): ?> selected <?php endif; ?>>published</option>
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/admin/blog/lists.blade.php ENDPATH**/ ?>