...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="number" name="points"
                                                    value="<?php echo e(!empty($webinar) ? $webinar->points : old('points')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15 ">
                                                <label
                                                    class="input-label d-block"><?php echo e(trans('admin/main.select_a_instructor')); ?></label>
                                                ...
                                                <select name="teacher_id" data-search-option="except_user"
                                                    ...
                                                    <?php if(!empty($webinar)): ?>
                                                        <option value="<?php echo e($webinar->teacher->id); ?>" selected>
                                                            <?php echo e($webinar->teacher->full_name); ?></option>
                                                    <?php else: ?>
                                                        <option selected disabled><?php echo e(trans('public.select_a_teacher')); ?>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="image_cover" id="cover_image"
                                                        value="<?php echo e(!empty($webinar) ? $webinar->image_cover : old('image_cover')); ?>"
                                                        class="form-control <?php $__errorArgs = ['image_cover'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-25">
                                                <label class="input-label"><?php echo e(trans('public.demo_video')); ?>

                                                    (<?php echo e(trans('public.optional')); ?>)</label>


                                                <div class="">
                                                    <label
                                                        class="input-label font-12"><?php echo e(trans('public.source')); ?></label>
                                                    <select name="video_demo_source"
                                                        ...
                                                        <?php $__currentLoopData = \App\Models\Webinar::$videoDemoSource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($source); ?>"
                                                                <?php if(!empty($webinar) and $webinar->video_demo_source == $source): ?> selected <?php endif; ?>>
                                                                <?php echo e(trans('update.file_source_' . $source)); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                class="js-video-demo-other-inputs form-group mt-0 <?php echo e((empty($webinar) or $webinar->video_demo_source != 'secure_host') ? '' : 'd-none'); ?>">
                                                <label class="input-label font-12"><?php echo e(trans('update.path')); ?></label>
                                                <div class="input-group js-video-demo-path-input">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="js-video-demo-path-upload input-group-text admin-file-manager <?php echo e((empty($webinar) or empty($webinar->video_demo_source) or $webinar->video_demo_source == 'upload') ? '' : 'd-none'); ?>"
                                                            data-input="demo_video" data-preview="holder">
                                                            <i class="fa fa-upload"></i>
                                                        </button>

                                                        <button type="button"
                                                            class="js-video-demo-path-links rounded-left input-group-text input-group-text-rounded-left  <?php echo e((empty($webinar) or empty($webinar->video_demo_source) or $webinar->video_demo_source == 'upload') ? 'd-none' : ''); ?>">
                                                            <i class="fa fa-link"></i>
                                                        </button>
                                                    </div>
                                                    <input type="text" name="video_demo" id="demo_video"
                                                        value="<?php echo e(!empty($webinar) ? $webinar->video_demo : old('video_demo')); ?>"
                                                        class="form-control <?php $__errorArgs = ['video_demo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div
                                                class="form-group js-video-demo-secure-host-input <?php echo e((!empty($webinar) and $webinar->video_demo_source == 'secure_host') ? '' : 'd-none'); ?>">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <div class="custom-file js-ajax-s3_file">
                                                        <input type="file" name="video_demo_secure_host_file"
                                                            ...
                                                            id="video_demo_secure_host_file" accept="video/*">
                                                        <label class="custom-file-label cursor-pointer"
                                                            for="video_demo_secure_host_file"><?php echo e(trans('update.choose_file')); ?></label>
                                                    </div>
                                ...
                                <section class="mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="form-group mt-15">
                                                <label
                                                    class="input-label"><?php echo e(trans('update.sales_count_number')); ?></label>
                                                <input type="number" name="sales_count_number"
                                                    value="<?php echo e(!empty($webinar) ? $webinar->sales_count_number : old('sales_count_number')); ?>"
                                                    class="form-control <?php $__errorArgs = ['sales_count_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                <p class="mt-1 text-muted text-gray">
                                                    <?php echo e(trans('update.product_sales_count_number_hint')); ?></p>
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <label class="input-label"><?php echo e(trans('public.duration')); ?>

                                                            (<?php echo e(trans('public.minutes')); ?>)</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="number" name="duration"
                                                                value="<?php echo e(!empty($webinar) ? $webinar->duration : old('duration')); ?>"
                                                    ...
                                                    <select name="timezone" class="form-control select2"
                                                        ...
                                                        <?php $__currentLoopData = getListOfTimezones(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timezone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($timezone); ?>"
                                                                <?php if($selectedTimezone == $timezone): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div
                                                class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                <label class=""
                                                    for="includeCertificateSwitch"><?php echo e(trans('update.include_certificate')); ?></label>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="certificate"
                                                        class="custom-control-input" id="includeCertificateSwitch"
                                                        <?php echo e(!empty($webinar) && $webinar->certificate ? 'checked' : ''); ?>>
                                            ...
                                            <div
                                                class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                <label class=""
                                                    for="forumSwitch"><?php echo e(trans('update.course_forum')); ?></label>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="forum" class="custom-control-input"
                                                        id="forumSwitch"
                                                        <?php echo e(!empty($webinar) && $webinar->forum ? 'checked' : ''); ?>>
                                            ...
                                            <div
                                                class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                <label class=""
                                                    for="enable_waitlistSwitch"><?php echo e(trans('update.enable_waitlist')); ?></label>
                                                <div class="custom-control custom-switch">
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="access_days"
                                                    value="<?php echo e(!empty($webinar) ? $webinar->access_days : old('access_days')); ?>"
                                                    class="form-control <?php $__errorArgs = ['access_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php if(!empty($webinar)): ?>
                                                <?php echo $__env->make('admin.product_badges.content_include', [
                                                    'itemTarget' => $webinar,
                                            ...
                                            <div id="partnerInstructorInput"
                                                ...
                                                <select name="partners[]" multiple data-search-option="just_teacher_role"
                                                    class="js-search-partner-user form-control <?php echo e(!empty($webinar) && $webinar->partner_instructor ? 'search-user-select22' : ''); ?>"
                                                    ...
                                                    <?php if(!empty($webinarPartnerTeacher)): ?>
                                                        <?php $__currentLoopData = $webinarPartnerTeacher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(!empty($partner) and $partner->teacher): ?>
                                                                <option value="<?php echo e($partner->teacher->id); ?>" selected>
                                                                    <?php echo e($partner->teacher->full_name); ?></option>
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                </select>
                                                ...
                                                <?php $__currentLoopData = $webinarCategoryFilters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-12 col-md-3">
                                                        <div class="webinar-category-filters">
                                                            <strong
                                                                class=" category-filter-title text-light d-block"><?php echo e($filter->title); ?></strong>
                                                            <div class="py-10"></div>
                                ...
                                <?php if(!empty($webinar)): ?>
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h2 class="section-title after-line"><?php echo e(trans('admin/main.price_plans')); ?>

                                            </h2>
                                            <button id="webinarAddTicket" type="button"
                                                class="btn btn-primary btn-sm mt-3"><?php echo e(trans('admin/main.add_price_plan')); ?></button>
                                        </div>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo e(dateTimeFormat($ticket->start_date, 'j M Y')); ?>

                                                                        - <?php echo e(dateTimeFormat($ticket->end_date, 'j M Y')); ?>
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="webinarAddPrerequisites" type="button"
                                                class="btn btn-primary btn-sm mt-3"><?php echo e(trans('public.add_prerequisites')); ?></button>
                                        </div>
                                                ...
                                                <?php if(!empty($prerequisites) and !$prerequisites->isEmpty()): ?>
                                                    <div class="table-responsive">
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <tr>
                                                                <th><?php echo e(trans('public.title')); ?></th>
                                                                <th class="text-left"><?php echo e(trans('public.instructor')); ?>
                                                            ...
                                                            <?php $__currentLoopData = $prerequisites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prerequisite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if(!empty($prerequisite->prerequisiteWebinar->title)): ?>
                                                                    <tr>
                                                                        <th><?php echo e($prerequisite->prerequisiteWebinar->title); ?>

                                                                        </th>
                                                                        <td class="text-left">
                                                                            <?php echo e($prerequisite->prerequisiteWebinar->teacher->full_name); ?>

                                                                        </td>
                                                                        <td><?php echo e(handlePrice($prerequisite->prerequisiteWebinar->price)); ?>

                                                                        </td>
                                                                        <td><?php echo e(dateTimeFormat($prerequisite->prerequisiteWebinar->created_at, 'j F Y | H:i')); ?>

                                                                        </td>
                                                                        <td><?php echo e($prerequisite->required ? trans('public.yes') : trans('public.no')); ?>

                                                                        </td>

                                                                        <td>
                                                                            <button type="button"
                                                                                data-prerequisite-id="<?php echo e($prerequisite->id); ?>"
                                                                                data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>"
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="webinarAddFAQ" type="button"
                                                class="btn btn-primary btn-sm mt-3"><?php echo e(trans('public.add_faq')); ?></button>
                                        </div>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button"
                                                                            class="js-get-faq-description btn btn-sm btn-gray200"><?php echo e(trans('public.view')); ?></button>
                                                                        <input type="hidden"
                                                                            value="<?php echo e($faq->answer); ?>" />
                                                                    </td>
                                        ...
                                        <section class="mt-30">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h2 class="section-title after-line">
                                                    <?php echo e(trans('update.' . $webinarExtraDescriptionType)); ?></h2>
                                                <button id="add_new_<?php echo e($webinarExtraDescriptionType); ?>" type="button"
                                                    class="btn btn-primary btn-sm mt-3"><?php echo e(trans('update.add_' . $webinarExtraDescriptionType)); ?></button>
                                            </div>
                                                            ...
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                <?php $__currentLoopData = $webinarExtraDescriptionValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extraDescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <?php if($webinarExtraDescriptionType == \App\Models\WebinarExtraDescription::$COMPANY_LOGOS): ?>
                                                                            <td>
                                                                                <img src="<?php echo e($extraDescription->value); ?>"
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="webinarAddQuiz" type="button"
                                                class="btn btn-primary btn-sm mt-3"><?php echo e(trans('public.add_quiz')); ?></button>
                                        </div>
                                        <div class="row mt-10">
                                            <div class="col-12">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/admin/webinars/create.blade.php ENDPATH**/ ?>