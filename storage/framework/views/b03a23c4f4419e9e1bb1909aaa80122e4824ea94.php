...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script>
        var defaultItemType =
            '<?php echo e(!empty(request()->get('type')) ? request()->get('type') : (!empty($userLearningLastView) ? $userLearningLastView->item_type : '')); ?>'
        var defaultItemId =
            '<?php echo e(!empty(request()->get('item')) ? request()->get('item') : (!empty($userLearningLastView) ? $userLearningLastView->item_id : '')); ?>'
        var loadFirstContent =
        <?php echo e((!empty($dontAllowLoadFirstContent) and $dontAllowLoadFirstContent) ? 'false' : 'true'); ?>; // allow to load first content when request item is empty
...
<?php echo $__env->make('web.default.layouts.app', ['appFooter' => false, 'appHeader' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akashchourasia/Downloads/__MACOSX/resources/views/web/default/course/learningPage/index.blade.php ENDPATH**/ ?>