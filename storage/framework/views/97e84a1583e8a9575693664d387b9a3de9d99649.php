<?php $__env->startSection('content'); ?>
    <section class="site-top-banner search-top-banner opacity-04 position-relative text-light">
            ...
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <span class="course-count-badge py-5 px-10 text-white rounded"><?php echo e($blogCount); ?>

                            <?php echo e(trans('site.posts')); ?></span>
                            ...
                            <form action="/blog" method="get">
                                <div class="form-group d-flex align-items-center m-0">
                                    <input type="text" name="search" class="form-control border-0"
                                        ...
                                        placeholder="<?php echo e(trans('home.blog_search_placeholder')); ?>" />
                                    <button type="submit"
    ...
    <section class="container mt-10 mt-md-40">
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="p-20 mt-30 rounded-sm shadow-lg border border-gray300">
                    <h3 class=" category-filter-title text-light font-20 font-weight-bold text-dark-blue">
                        <?php echo e(trans('site.popular_posts')); ?></h3>
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oxlircor/wayspire-dev.oxlide.co.in/resources/views/web/default/blog/index.blade.php ENDPATH**/ ?>