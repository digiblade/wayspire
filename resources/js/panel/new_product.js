(function ($) {
    ...
    $("body").on("change", "#categories", function (e) {
        ...
        $.get(
            "/panel/store/products/filters/get-by-category-id/" + category_id,
            function (result) {
                if (
                    result &&
    ...
    function handleSpecificationInputType($form, specificationId) {
        $.get(
            "/panel/store/products/specifications/" + specificationId + "/get",
            function (result) {
                if (result) {
    ...
    $("body").on("change", ".js-product-content-locale", function (e) {
        ...
        const path =
            "/panel/store/products/" + productId + "/getContentItemByLocale";
        const data = {
            item_id,
            locale,
            relation,
