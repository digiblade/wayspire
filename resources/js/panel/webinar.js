(function ($) {
    ...
    function handleGetFiltersTitleFromTranslations(
        translations,
        defaultLocale
    ) {
        let title = null;
                ...
                if (
                    ...
                    Object.keys(result.filters).forEach((key) => {
                        ...
                        if (!filterTitle && filter.translations) {
                            filterTitle = handleGetFiltersTitleFromTranslations(
                                filter.translations,
                                defaultLocale
                            );
                        }
                        ...
                        if (options.length) {
                            Object.keys(options).forEach((index) => {
                                ...
                                if (!optionTitle && option.translations) {
                                    optionTitle =
                                        handleGetFiltersTitleFromTranslations(
                                            option.translations,
                                            defaultLocale
                                        );
                                }
        ...
        Swal.fire({
            ...
            onOpen: function () {
                ...
                if (itemId) {
                    ...
                    $.get(
                        "/panel/chapters/" + itemId + "?locale=" + locale,
                        function (result) {
