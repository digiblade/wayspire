                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div
                                                class="js-video-demo-other-inputs form-group mt-0 {{ (empty($bundle) or $bundle->video_demo_source != 'secure_host') ? '' : 'd-none' }}">
                                            ...
                                            <div
                                                class="form-group js-video-demo-secure-host-input {{ (!empty($bundle) and $bundle->video_demo_source == 'secure_host') ? '' : 'd-none' }}">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <label class=""
                                                        for="includeCertificateSwitch">{{ trans('update.bundle_completion_certificate') }}</label>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="certificate"
                                                            class="custom-control-input" id="includeCertificateSwitch"
                                                            {{ !empty($bundle) && $bundle->certificate ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                            for="includeCertificateSwitch"></label>
                                                    </div>
                                                </div>

                                                <p class="mt-10 font-12 text-gray">-
                                                    {{ trans('update.bundle_completion_certificate_hint') }}</p>
                                            </div>
