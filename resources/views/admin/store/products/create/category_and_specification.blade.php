    ...
    <div class="row">
        ...
        <div class="col-12 mt-20">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="px-2 mt-3">
                    <button type="button" id="productAddSpecification"
                        class="btn btn-primary btn-sm">{{ trans('update.new_specification') }}</button>
                </div>
            </div>

            <div class="accordion-content-wrapper mt-15" id="specificationsAccordion" role="tablist"
