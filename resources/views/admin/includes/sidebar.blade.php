    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_course_personal_notes')
                            @if (!empty(getFeaturesSettings('course_notes_status')))
                                <li
                                    class="{{ request()->is(getAdminPanelUrl('/webinars/personal-notes', false)) ? 'active' : '' }}">
                                    <a class="nav-link"
                                        href="{{ getAdminPanelUrl() }}/webinars/personal-notes">{{ trans('update.course_notes') }}</a>
                                </li>
                            @endif
                        @endcan
            ...
            {{-- @if ($authUser->can('admin_user_login_history') or $authUser->can('admin_user_ip_restriction'))
                <li
                    class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/users/login-history*', false)) or request()->is(getAdminPanelUrl('/users/ip-restriction*', false))) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_user_login_history')
                            <li
                                class="nav-item {{ request()->is(getAdminPanelUrl('/users/login-history*', false)) ? 'active' : '' }}">
                        ...
                        @can('admin_user_ip_restriction')
                            <li
                                class="nav-item {{ request()->is(getAdminPanelUrl('/users/ip-restriction*', false)) ? 'active' : '' }}">
            ...
            @can('admin_supports')
                <li
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_supports_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/supports', false)) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/custom/job-post">List</a>
                            </li>
                        @endcan

                        @can('admin_supports_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/supports/create', false)) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/custom/create">New Job</a>
                            </li>
                        @endcan
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_forms_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/forms/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/forms/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_forms_lists')
                            <li class="{{ request()->is(getAdminPanelUrl('/forms', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/forms">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_forms_submissions')
                            <li class="{{ request()->is(getAdminPanelUrl('/forms/submissions', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/forms/submissions">{{ trans('update.submissions') }}</a>
                            </li>
                        @endcan()
            ...
            {{-- @can('admin_ai_contents')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/ai-contents*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_ai_contents_templates_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/ai-contents/templates/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_ai_contents_templates_lists')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/ai-contents/templates', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_ai_contents_settings')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/ai-contents/settings', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/ai-contents/settings">{{ trans('update.settings') }}</a>
                            </li>
                        @endcan()
            ...
            @can('admin_content_delete_requests_lists')
                <li
                    class="nav-item {{ request()->is(getAdminPanelUrl('/content-delete-requests*', false)) ? 'active' : '' }}">
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_discount_codes_list')
                            <li
                                class="{{ (request()->is(getAdminPanelUrl('/financial/discounts', false)) and empty(request()->get('instructor_coupons'))) ? 'active' : '' }}">
                                <a class="nav-link"
                        ...
                        @can('admin_discount_codes_list')
                            <li
                                class="{{ (request()->is(getAdminPanelUrl('/financial/discounts', false)) and !empty(request()->get('instructor_coupons'))) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/discounts?instructor_coupons=1">{{ trans('update.instructor_coupons') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            {{-- @can('admin_abandoned_cart')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/abandoned-cart*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_abandoned_cart_rules')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/abandoned-cart/rules/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/abandoned-cart/rules/create') }}">{{ trans('update.new_rule') }}</a>
                            </li>

                            <li
                                class="{{ request()->is(getAdminPanelUrl('/abandoned-cart/rules', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/abandoned-cart/rules') }}">{{ trans('update.rules') }}</a>
                            </li>
                        @endcan

                        @can('admin_abandoned_cart_users')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/abandoned-cart/users-carts', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/abandoned-cart/users-carts') }}">{{ trans('update.users_carts') }}</a>
                            </li>
                        @endcan

                        @can('admin_abandoned_cart_settings')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/abandoned-cart/settings', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/abandoned-cart/settings') }}">{{ trans('update.settings') }}</a>
                            </li>
                        @endcan
            ...
            {{-- @can('admin_purchase_notifications')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/purchase_notifications*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_purchase_notifications_lists')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/purchase_notifications', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/purchase_notifications') }}">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_purchase_notifications_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/purchase_notifications/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/purchase_notifications/create') }}">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
            ...
            @can('admin_product_badges')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/product-badges*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fa fa-tag"></i>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_product_badges_lists')
                            <li class="{{ request()->is(getAdminPanelUrl('/product-badges', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/product-badges') }}">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_product_badges_create')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/product-badges/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl('/product-badges/create') }}">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
