                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div
                                                class="js-video-demo-other-inputs form-group mt-0 {{ (empty($webinar) or $webinar->video_demo_source != 'secure_host') ? '' : 'd-none' }}">
                                            ...
                                            <div
                                                class="form-group js-video-demo-secure-host-input {{ (!empty($webinar) and $webinar->video_demo_source == 'secure_host') ? '' : 'd-none' }}">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <div class="custom-file js-ajax-s3_file">
                                                        ...
                                                        <label class="custom-file-label cursor-pointer"
                                                            for="video_demo_secure_host_file">{{ trans('update.choose_file') }}</label>
                                                    </div>
                                ...
                                <section class="mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="form-group mt-15">
                                                <label
                                                    class="input-label">{{ trans('update.sales_count_number') }}</label>
                                                <input type="number" name="sales_count_number"
                                                    value="{{ !empty($webinar) ? $webinar->sales_count_number : old('sales_count_number') }}"
                                                    class="form-control @error('sales_count_number')  is-invalid @enderror" />
                                                ...
                                                <p class="mt-1 text-muted text-gray">
                                                    {{ trans('update.product_sales_count_number_hint') }}</p>
                                            </div>
                                            ...
                                            <div
                                                class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                <label class=""
                                                    for="enable_waitlistSwitch">{{ trans('update.enable_waitlist') }}</label>
                                                <div class="custom-control custom-switch">
                                            ...
                                            {{-- Product Badges --}}
                                            @if (!empty($webinar))
                                                @include('admin.product_badges.content_include', [
                                                    'itemTarget' => $webinar,
                                                ])
                                            @endif
                                                ...
                                                @foreach ($webinarCategoryFilters as $filter)
                                                    <div class="col-12 col-md-3">
                                                        <div class="webinar-category-filters">
                                                            <strong
                                                                class=" category-filter-title text-light d-block">{{ $filter->title }}</strong>
                                                            <div class="py-10"></div>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach ($tickets as $ticket)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ dateTimeFormat($ticket->start_date, 'j M Y') }}
                                                                        - {{ dateTimeFormat($ticket->end_date, 'j M Y') }}
                                                                    </td>
                                                                    <td>
                                                                        <button type="button"
