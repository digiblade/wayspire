...
@section('content')
    <section class="">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h1 class="section-title text-light">{{ trans('panel.dashboard') }}</h1>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-3 mt-35">
                ...
                <a href="@if ($authUser->isUser()) /panel/meetings/reservation @else /panel/financial/sales @endif"
                    ...
                    <div class="d-flex flex-column ml-15">
                        <span
                            class="font-30 text-secondary">{{ !empty($monthlySalesCount) ? handlePrice($monthlySalesCount) : (!empty($reserveMeetingsCount) ? $reserveMeetingsCount : 0) }}</span>
                        <span
