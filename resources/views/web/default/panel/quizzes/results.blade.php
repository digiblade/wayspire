                                ...
                                <select name="quiz_id" class="form-control select2"
                                    ...
                                    @foreach ($quizzes as $quiz)
                                        <option value="{{ $quiz->id }}"
                                            @if (request()->get('quiz_id') == $quiz->id) selected @endif>
                                            {{ $quiz->title . ' - ' . ($quiz->webinar ? $quiz->webinar->title : '-') }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                        ...
                                        <select name="user_id" class="form-control select2"
                                            ...
                                            @foreach ($allStudents as $student)
                                                <option value="{{ $student->id }}"
                                                    @if (request()->get('user_id') == $student->id) selected @endif>
            ...
            <form action="/panel/quizzes/results" method="get" class="">
                <div
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" name="open_results" class="custom-control-input"
                            id="onlyOpenQuizzesSwitch" @if (request()->get('open_results', null) == 'on') checked @endif>
                                ...
                                <tbody>
                                    @foreach ($quizzesResults as $result)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                {{ dateTimeFormat($result->created_at, 'j M Y H:i') }}</td>
