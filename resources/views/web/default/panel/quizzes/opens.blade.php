                                            ...
                                            <td class="text-left">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    <div class="avatar bg-gray200">
                                                        <img src="{{ $quiz->creator->getAvatar() }}" class="img-cover"
                                                            alt="">
                                                    </div>
                                                    <div class=" ml-5">
                                                        <span
                                                            class="d-block text-dark-blue font-weight-500">{{ $quiz->creator->full_name }}</span>
                                                        <span
                                                            class="mt-5 font-12 text-gray d-block">{{ $quiz->creator->email }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-left">
                                                ...
                                                <span
                                                    class="font-12 mt-5 text-gray d-block">{{ $quiz->webinar->title }}</span>
                                            </td>
                                            <td class="text-dark-blue font-weight-500 align-middle">
                                                {{ $quiz->quizQuestions->sum('grade') }}</td>


                                            <td class="text-dark-blue font-weight-500 align-middle">
                                                {{ dateTimeFormat($quiz->created_at, 'j M Y H:i') }}</td>
                                                ...
                                                <div
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="/panel/quizzes/{{ $quiz->id }}/start"
                                                            class="webinar-actions d-block mt-10">{{ trans('public.start') }}</a>
