...
<div class="row">
    <div class="col-12 col-md-6 mt-15">
            ...
            <div class="form-group mt-30 d-flex align-items-center justify-content-between mb-5">
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="forum" class="custom-control-input" id="forumSwitch"
                        {{ !empty($webinar) && $webinar->forum ? 'checked' : (old('forum') ? 'checked' : '') }}>
        ...
        <div class="form-group mt-30 d-flex align-items-center justify-content-between">
            ...
            <div class="custom-control custom-switch">
                <input type="checkbox" name="support" class="custom-control-input" id="supportSwitch"
                    {{ (!empty($webinar) && $webinar->support or old('support') == 'on') ? 'checked' : '' }}>
            ...
            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="certificate" class="custom-control-input" id="certificateSwitch"
                        {{ (!empty($webinar) && $webinar->certificate or old('certificate') == 'on') ? 'checked' : '' }}>
        ...
        <div class="form-group mt-30 d-flex align-items-center justify-content-between">
            ...
            <div class="custom-control custom-switch">
                <input type="checkbox" name="downloadable" class="custom-control-input" id="downloadableSwitch"
                    {{ (!empty($webinar) && $webinar->downloadable or old('downloadable') == 'on') ? 'checked' : '' }}>
        ...
        <div class="form-group mt-30 d-flex align-items-center justify-content-between">
            ...
            <div class="custom-control custom-switch">
                <input type="checkbox" name="partner_instructor" class="custom-control-input"
                    ...
                    {{ (!empty($webinar) && $webinar->partner_instructor or old('partner_instructor') == 'on') ? 'checked' : '' }}>
        ...
        <div id="partnerInstructorInput"
            class="form-group mt-15 {{ (!empty($webinar) && $webinar->partner_instructor or old('partner_instructor') == 'on') ? '' : 'd-none' }}">
            <label class="input-label d-block">{{ trans('public.select_a_partner_teacher') }}</label>

            <select name="partners[]"
                class="form-control panel-search-user-select2 @error('partners')  is-invalid @enderror" multiple=""
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" name="tags" data-max-tag="5"
                value="{{ !empty($webinar) ? implode(',', $webinarTags) : '' }}" class="form-control inputtags"
