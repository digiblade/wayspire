                                        ...
                                        <tr>
                                            <td class="text-left align-middle" width="35%">
                                                <a class="text-dark-blue font-weight-500"
                                                    href="{{ $comment->webinar->getUrl() }}"
                                                    target="_blank">{{ $comment->webinar->title }}</a>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                @if ($comment->status == 'active')
                                                    <span
                                                        class="text-primary text-dark-blue font-weight-500">{{ trans('public.published') }}</span>
                                                @else
                                                    <span
                                                        class="text-warning text-dark-blue font-weight-500">{{ trans('public.pending') }}</span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="align-middle text-right">
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <button type="button" data-comment-id="{{ $comment->id }}"
                                                            class="js-edit-comment btn-transparent">{{ trans('public.edit') }}</button>
                                                        <a href="/panel/webinars/comments/{{ $comment->id }}/delete"
                                                            class="delete-action btn-transparent d-block mt-10">{{ trans('public.delete') }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
