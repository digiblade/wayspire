        ...
        <div class="custom-dropdown-body pb-10">
            ...
            <div class="dropdown-user-avatar d-flex align-items-center p-15 m-15 mb-10 rounded-sm border">
                <div class="size-40 rounded-circle position-relative">
                    <img src="{{ $authUser->getAvatar() }}" class="img-cover rounded-circle"
...
@else
    <div class="d-flex align-items-center ml-md-50">
        <a href="/login" class="py-5 px-10 mr-10 text-light font-14">{{ trans('auth.login') }}</a>
        <a href="/register" class="py-5 px-10 text-light  font-14">{{ trans('auth.register') }}</a>
    </div>
@endif
