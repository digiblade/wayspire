                    ...
                    <form action="/gift/{{ $itemType }}/{{ $item->slug }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="date" type="text"
                                class="form-control datetimepicker @error('date') is-invalid @enderror" autocomplete="off">
                            @error('date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <button type="submit"
                            class="btn btn-primary btn-block mt-20">{{ trans('update.proceed_to_checkout') }}</button>
                    </form>
                </div>
