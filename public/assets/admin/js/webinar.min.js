  ...
  \***************************************/
    ...
    (function ($) {
                ...
                if (target.length) {
                    target.sortable({
                        ...
                        update: function update(e, ui) {
                            ...
                            var table =
                                e.target.getAttribute("data-order-table");
            ...
            if ($fileForms && $fileForms.length) {
                $fileForms.each(function (key) {
                    if ($fileForms[key]) {
                        ...
                        var secureHostType = $form
                            .find(
                                ".js-secure-host-upload-type-field input:checked"
                            )
                            .val();
                        ...
                        $.get(
                            ...
                            function (result) {
                                if (result && result.chapter) {
                                    ...
                                    var checkedAllContents =
                                        result.chapter
                                            .check_all_contents_pass &&
                                        result.chapter
                                            .check_all_contents_pass !== "0";
                                    modal
                                        .find(
                                            ".js-chapter-check-all-contents-pass"
                                        )
        ...
        function handleShowFileInputsBySource($form, source, fileType) {
            ...
            var $secureHostUploadTypeField = $form.find(
        ...
        $("body").on("click", ".assignment-attachments-add-btn", function (e) {
            var $container = $(this).closest(
                ".js-assignment-attachments-items"
            );
            ...
            $.post(
                ...
                function (result) {
                    if (result && result.webinarExtraDescription) {
                        ...
                        html = html.replaceAll(
                            adminPanelPrefix +
                                "/webinar-extra-description/store",
                            adminPanelPrefix +
                                "/webinar-extra-description/" +
                                item_id +
                                "/update"
        ...
        $("body").on("change", 'select[name="type"]', function () {
            ...
            for (
                var _i = 0, _webinarItem = webinarItem;
                _i < _webinarItem.length;
                _i++
            ) {
        ...
        $("body").on("change", ".js-sequence-content-switch", function () {
            ...
            var sequenceContentInputs = parent.find(
                ".js-sequence-content-inputs"
            );
            ...
            $.post(
                ...
                function (result) {
                    if (result && result.bundleWebinar) {
                        ...
                        var selectHtml = '<option value="'
                            .concat(bundleWebinar.webinar_id, '" selected>')
                            .concat(bundleWebinar.webinar_title, "</option>");
