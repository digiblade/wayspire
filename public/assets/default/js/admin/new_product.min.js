            ...
            /***/ function (module, exports) {
                ...
                (function ($) {
                    ...
                    $("body").on("click", "#productAddFile", function (e) {
                        ...
                        add_file_modal = add_file_modal.replaceAll(
                            "record",
                            nameId
                        );
                        Swal.fire({
                    ...
                    function handleProductItemForm(form, $this, action) {
                        ...
                        $.ajax({
                            ...
                            error: function error(err) {
                                $this
                                    .removeClass("loadingbar gray")
                                    .prop("disabled", false);
                                var errors = err.responseJSON;

                                if (errors && errors.errors) {
                                    Object.keys(errors.errors).forEach(
                                        function (key) {
                ...
                return {
                    ...
                    $(document).ready(function () {
                        handleSpecificationMultiValueSelect2(
                            "select-multi-values-select2"
                        );
                        handleSpecificationSelect2(
                            "search-specification-select2"
                        );
                    });

                    function handleSpecificationInputType(
                        $form,
                        specificationId
                    ) {
                        $.get(
                            ...
                            function (result) {
                                if (result) {
                                    ...
                                    var multiValuesInput = $form.find(
                                        ".js-multi-values-input"
                                    );
                                    var summaryInput =
                                        $form.find(".js-summery-input");
                                    var allowSelectionInput = $form.find(
                                        ".js-allow-selection-input"
                                    );
                                    $form
                                        .find(".js-input-type")
                                        .val(specification.input_type);
                                    allowSelectionInput
                                        .find("input")
                                        .prop("checked", false);
                                    ...
                                    if (
                                        ...
                                        allowSelectionInput.removeClass(
                                            "d-none"
                                        );
                        ...
                        $.get(
                            ...
                            function (result) {
                                if (
                                    ...
                                    var html = "";
                                    Object.keys(result.filters).forEach(
                                        function (key) {
                                    ...
                                    $("#categoriesFiltersContainer").addClass(
                                        "d-none"
                                    );
                    ...
                    function handleFileItemsByType($form) {
                        ...
                        var $onlineViewerInput = $form.find(
                            ".js-online_viewer-input"
                        );
  ...
  \*************************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! /home/jack/projects/webinar/resources/js/admin/new_product.js */ "./resources/js/admin/new_product.js"
                );
