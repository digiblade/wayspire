  ...
  \*******************************************/
    ...
    (function ($) {
        ...
        $("body").on("change", "#categories", function (e) {
            ...
            $.get(
                "/panel/store/products/filters/get-by-category-id/" +
                    category_id,
                function (result) {
                    if (
                        result &&
        ...
        function handleSpecificationInputType($form, specificationId) {
            $.get(
                "/panel/store/products/specifications/" +
                    specificationId +
                    "/get",
                function (result) {
                    if (result) {
                        ...
                        if (specification.input_type === "multi_value") {
                            ...
                            if (multiValues) {
                                var _iterator =
                                        _createForOfIteratorHelper(multiValues),
                                    _step;
                                try {
                                    for (
                                        _iterator.s();
